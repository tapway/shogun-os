...
import { CheckCircle, Clock, AlertTriangle, ChevronDown, ChevronUp, Package, User, Building2, Calendar } from "lucide-react";
import type { ProgressTrackerProject } from "../../../lib/types";
    ...
    <div className="sd-stack">
      ...
      <div className="sd-kpi-grid">
        <div className="sd-kpi-card">
          ...
          <div className="sd-kpi-value">{projects.length}</div>
        </div>
        <div className="sd-kpi-card">
        ...
        <div className="sd-kpi-card">
          <div className="sd-kpi-label">Completed</div>
          <div className="sd-kpi-value" style={{ color: "var(--samurai-ok)" }}>
                                    ...
                                    return (
                                      ...
                                      >
                                        <div style={{ minWidth: "1.5rem", display: "flex", justifyContent: "center" }}>
                                          <StepIcon className="h-4 w-4" style={{ color: stepStatusStyle.bg }} />
                                        </div>
                                        <div style={{ flex: 1 }}>
