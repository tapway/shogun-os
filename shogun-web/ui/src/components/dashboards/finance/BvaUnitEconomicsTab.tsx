...
// For the BvA tab, budget comes from Excel (monthly_budget), actual comes from QBO.
    ...
    <div className="sd-stack">
      ...
      {activeLine && (
        <FinanceDetailModal
          ...
          subtitle={`${activeLine.section} — Monthly Budget Breakdown (Budget from Excel, Actuals from QBO)`}
...
function BvaSection({
  ...
  return (
    <div className="sd-chart-card" style={{ padding: '1.1rem' }}>
      ...
      <p className="sd-chart-sub">Budget from 2026 Budget Excel · Actuals from QuickBooks Online (QBO)</p>
